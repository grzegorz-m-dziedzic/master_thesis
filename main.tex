...
Oba algorytmy zaimplementowane zostały z wykorzystaniem selekcji turniejowej, krzyżowania wielopunktowego (z losowym wyborem punktów podziału) oraz mutacji binarnej. Wskutek przeprowadzonego procesu strojenia ustalono, że algorytmy najlepiej pracują na następującym zestawie parametrów:\\
\begin{itemize}
	\item Wielkość populacji: 200.
	\item Wielkość populacji zewnętrznej (SPEA) : $1/4$ wielkości populacji.
	\item Prawdopodobieństwo krzyżowania : $0.9$.
	\item Prawdopodobieństwo mutacji : $0.006$.
	\item Wielkość turnieju: 2.
	\item Punkty podziału chromosomu dla krzyżowania: 2.
\end{itemize}
...
W celu zbadania działania wybranych algorytmów dla drugiego przypadku testowego [REF] wygenerowano 2000 generacji. Ponadto odnotowano wyniki z 100, 500 oraz 1000 pokolenia.
...
Podsumowując, z drugim przypadkiem testowym zdecydowanie lepiej poradził sobie algorytm NSGA-II, co dobrze widoczne jest na wykresach \eqref{fig:medium_front}.
\subsubsection{Trzeci przypadek testowy - obszar duży}
Dla trzeciego przypadku testowego [REF] algorytmy uruchomione zostały z ograniczeniem 5000 pokoleń. Ponadto, podobnie jak w poprzednich przypadkach, przeanalizowano dane wygenerowane również przy 100, 1000 oraz 2000 pokoleniu.
